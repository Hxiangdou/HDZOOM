import os
# ⚠️ 将此路径改为你机器上空间最大的目录
# 例如: "/data/fength/hf_cache" 或 "/mnt/data/cache"
os.environ["HF_HOME"] = "/data/fength/cache/huggingface"
os.environ["HF_DATASETS_CACHE"] = "/data/fength/cache/huggingface/datasets"
os.environ["HUGGING_FACE_HUB_CACHE"] = "/data/fength/cache/huggingface/hub"
...
# from dataloader.creatidesign_dataset_benchmark import collate_fn, collate_fn
from dataloader.creatidesign_dataset import DesignDataset, collate_fn
...
def main():
    ...
    for name, module in pipe.transformer.named_modules():
        pipe.transformer._set_gradient_checkpointing(module, True)
